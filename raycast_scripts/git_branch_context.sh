...
# @raycast.title Git 分支列表 (上下文感知)
# @raycast.mode fullOutput
# @raycast.packageName Git Context
#
# Optional parameters:
# @raycast.icon 🌿
# @raycast.description 动态获取前台App的工作目录，并列出该目录下的Git分支
